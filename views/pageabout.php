        ...
        <div class="main-container">
            <div class="main">
                <header>
                    <div class="overlay">
                        <div class="inner">
                            <img class="ava" src="img/foto profil.jpg" alt="">
                            <h1 class="title">Ryan Angga Rista</h1>
                            <p class="text">
                                Ryan Angga Rista lives ini Surabaya with his family, their father,
                                Mujiono, their mother, istini, their sister, Nanda, and his three cat.
                                he began his studying in automation at Politeknik Perkapalan negeri Surabaya.
                                Ryan made this website which will be used for the purposes of the final project
                                requirements for graduation. so pray for ryan to finish his education.
                            </p>
                        </div>
                    </div>
                </header>
