...
<body>
  <div id="cards" class="cards" align="center">
    ...
    <table id="wntable">
      ...
      <?php
          $sql=mysqli_query($conn, "SELECT * FROM tbl_sensor1, tbl_sensor2 where tbl_sensor1.waktuSensor1=tbl_sensor2.waktuSensor2 order by waktuSensor1 desc");
          if($sql === FALSE){
          ...
          if(mysqli_num_rows($sql) == 0){ 
            ...
            while($row = mysqli_fetch_assoc($sql)){ // fetch query yang sesuai ke dalam array
              ...
              <tr>
                ...
                <td>'.$row['kecepatanSensor1'].'</td>
                <td>'.$row['flowrateSensor2'].'</td>
                <td>'.$row['volumeSensor2'].'</td>
                <td>'.$row['kecepatanSensor2'].'</td>
