...
<body>
    <div id="cards" class="cards" align="center">
        ...
        <table id="wntable">
          ...
          $sql=mysqli_query($conn, "SELECT * FROM tbl_sensor11, tbl_sensor12 where tbl_sensor11.waktuSensor11=tbl_sensor12.waktuSensor12 order by waktuSensor11 desc");
        ...
        if(mysqli_num_rows($sql) == 0){ 
            ...
            <tr>
                ...
                <td>'.$row['flowrateSensor11'].'</td>
                <td>'.$row['volumeSensor11'].'</td>
                <td>'.$row['kecepatanSensor11'].'</td>
                <td>'.$row['waktuSensor10'].'</td>
            </tr>
            ';
